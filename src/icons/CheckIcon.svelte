...
<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="{width}" height="{height}" viewBox="0 0 100 100">
  <path d="M50,5C25.147,5,5,25.147,5,50c0,24.853,20.147,45,45,45s45-20.147,45-45C95,25.147,74.853,5,50,5z M43.667,74.86  L20.082,51.274l9.545-9.545L43.667,55.77l27.18-27.18l9.545,9.545L43.667,74.86z"/>
</svg>
<style>
  path {
    fill: currentColor;
