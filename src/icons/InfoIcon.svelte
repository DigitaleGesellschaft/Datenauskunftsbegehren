...
<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="{width}" height="{height}" viewBox="0 0 100 100">
  ...
  <path d="M50,21.562  c4.418,0,8,3.582,8,8s-3.582,8-8,8s-8-3.582-8-8S45.582,21.562,50,21.562z M62,76.438C62,77.542,61.104,78,60,78H40  c-1.104,0-2-0.458-2-1.562v-1C38,74.333,38.896,73,40,73h2V48h-2c-1.104,0-2-0.458-2-1.562v-1C38,44.333,38.896,43,40,43h16  c1.104,0,2,1.333,2,2.438v1V73h2c1.104,0,2,1.333,2,2.438V76.438z"/>
</svg>
